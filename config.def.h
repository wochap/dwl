...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, Key_grave,      focusortogglescratch, {.v = scratchpadcmd } },
    ...
    { MODKEY,                    Key_a,      	 rotatetags,     {.i = -1} },
    { MODKEY,                    Key_d,      	 rotatetags,     {.i =  1} },
    { MODKEY|WLR_MODIFIER_SHIFT, Key_a,      	 rotatetags,     {.i = -2} },
    { MODKEY|WLR_MODIFIER_SHIFT, Key_d,      	 rotatetags,     {.i =  2} },
